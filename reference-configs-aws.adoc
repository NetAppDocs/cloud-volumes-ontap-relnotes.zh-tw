...
. 使用 HA 配對時，Cloud Volumes ONTAP 的大多數執行個體類型支援高寫入速度。使用單節點系統時，所有執行個體類型均支援高寫入速度 https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-write-speed.html["深入瞭解如何選擇寫入速度"^]。
